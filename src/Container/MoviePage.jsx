...
const MoviePage = () => {
    const {data, loading, error, page, totalPage, genres, updateSorted, searchMovies, changePage} = useMoviesTV('movie')
    let content
    if(loading) {
        ...
        content =(
            <>
                <Grid>
                    {
                        data.map(item => (
                        <MovieCard data = {item} key = {item.id} path = {'movie'} />
                        ))
                    }
                </Grid>
           ...
           <Search data = {genres} onSearch = {searchMovies}/>
            <div className="movies__contents">
                <div className="movies__header">
                    <span className="movies__header__title">Featured Movies</span>
                    <div className="movies__header__sort">
                        ...
                        <select className="movies__header__selection" onChange = {updateSorted}>
                            ...
                            <option value = "vote_average.asc">Rating &uarr;</option>
